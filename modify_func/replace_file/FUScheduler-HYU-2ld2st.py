...
class KunminghuScheduler(Scheduler):
    IQs = [
        ...
        IssueQue(name='load0', inports=2, size=24, oports=[
            IssuePort(fu=[ReadPort()], rp=[IntRD(9, 0)])
        ]),
        # IssueQue(name='hpy0', inports=2, size=24, oports=[
        #     IssuePort(fu=[ReadPort(), WritePort()], rp=[IntRD(10, 0)])
        # ]),
        # IssueQue(name='hpy1', inports=2, size=24, oports=[
        #     IssuePort(fu=[ReadPort(), WritePort()], rp=[IntRD(11, 0)])
        # ]),


        IssueQue(name='load1', inports=2, size=24, oports=[
            IssuePort(fu=[ReadPort()], rp=[IntRD(9, 0)])
        ]),
        # IssueQue(name='load2', inports=2, size=24, oports=[
        #     IssuePort(fu=[ReadPort()], rp=[IntRD(10, 0)])
        # ]),
        IssueQue(name='store0', inports=2, size=24, oports=[
            IssuePort(fu=[WritePort()], rp=[IntRD(7, 2)])
        ]),
        IssueQue(name='store1', inports=2, size=24, oports=[
    ...
    __int_bank = ['intIQ0', 'intIQ1', 'intIQ2', 'intIQ3', 'load0', 'load1', 'store0', 'store1', 'std0', 'std1']
    ...
    specWakeupNetwork = [
        ...
        # SpecWakeupChannel(srcIQ='hpy0', dstIQ=__int_bank),
        # SpecWakeupChannel(srcIQ='hpy1', dstIQ=__int_bank),
    ]
