...
# bash $2/GEM5/util/xs_scripts/parallel_sim.sh `realpath ${work_src}/GEM5/util/xs_scripts/kmh_v3_ideal.sh ` ${lst_src} /nfs/home/yanyue/spec17_cpts/checkpoint-0-0-0/  res > outsim.log
