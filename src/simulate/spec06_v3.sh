echo "spec06_01c.sh, 获取到当前路径: $1"
echo "spec06_01c.sh, 获取到当前任务路径: $2"
echo "spec06_01c.sh, 获取到lst路径: $3"
echo "spec06_01c.sh, 获取任务结果名称: $4"
echo "GCBV_REF_SO: $5"
echo "GCB_RESTORER: $6"
echo "ckpt_path: $7"
source ~/.bashrc
...
# bash $2/GEM5/util/xs_scripts/parallel_sim.sh `realpath ${work_src}/GEM5/util/xs_scripts/kmh_v3_ideal.sh ` ${lst_src} /nfs/share/zyy/spec06_rv64gcb_O3_20m_gcc12.2.0-intFpcOff-jeMalloc/zstd-checkpoint-0-0-0/  res > outsim.log
bash $2/GEM5/util/xs_scripts/parallel_sim.sh `realpath ${work_src}/GEM5/util/xs_scripts/kmh_v3_ideal.sh ` ${lst_src} $7 res > outsim.log
